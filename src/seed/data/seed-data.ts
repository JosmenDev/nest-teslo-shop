...
export const initialData: SeedData = {
  users: [
    {
      email: 'josmendev@gmail.com',
      fullName: 'Jose Menacho',
      password: bcrypt.hashSync('Hola123456', +process.env.HASH_SALT),
      roles: ['admin']
    },
    {
      email: 'josmendev2@gmail.com',
      fullName: 'Jose Menacho2',
      password: bcrypt.hashSync('Hola123456', +process.env.HASH_SALT),
      roles: ['user']
    }
  ],
